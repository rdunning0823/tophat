...
const TCHAR HomeElevation[] = _T("HomeElevation");
const TCHAR HomeElevationAvailable[] = _T("HomeElevationAvailable");
...
const TCHAR ContestNationality[] = _T("ContestNationality");
...
const TCHAR StartupTipDeclineVersion[] = _T("StartupTipDeclineVersion");
const TCHAR StartupTipId[] = _T("StartupTipId");
