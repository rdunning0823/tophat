...
#include "TophatWidgets/ZoomOutButtonWidget.hpp"
#include "TophatWidgets/TaskPreviousButtonWidget.hpp"
#include "TophatWidgets/TaskNextButtonWidget.hpp"
#include "Asset.hpp"
...
MainWindow::ReinitialiseLayout()
{
  ...
  look->ReinitialiseLayout(ui_settings, ib_layout.control_size.cx);
