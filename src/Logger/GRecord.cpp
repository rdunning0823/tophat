...
GRecord::Initialize(int key_id)
{
  ...
  case 2:
    // key 2
    md5[0].InitKey(0xeaa9fbd3,0x9cb4e90a,0x0bc8f0ea,0x03a9e01a);
    md5[1].InitKey(0x3c4a4c93,0xeaa9fbd3,0xa9bcd0ea,0x9a8c2aaa);
    md5[2].InitKey(0x3c9ae1f1,0x9fe02a1f,0x3fc9a497,0xeaa9fbd3);
    md5[3].InitKey(0x41a0c8e8,0xf0e37acf,0xeaa9fbd3,0x9bed015a);
    break;
