...
#include "org_tophat_InternalGPS.h"
#include "org_tophat_NonGPSSensors.h"
...
Java_org_tophat_InternalGPS_setConnected(JNIEnv *env, jobject obj,
                                         jint connected)
{
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_tophat_InternalGPS_setLocation(JNIEnv *env, jobject obj,
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_tophat_NonGPSSensors_setGliderLinkInfo(
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_tophat_NonGPSSensors_setAcceleration(
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_tophat_NonGPSSensors_setRotation(
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_tophat_NonGPSSensors_setMagneticField(
...
/**
 * Helper function for
 * Java_org_tophat_NonGPSSensors_setBarometricPressure: Given a
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_tophat_NonGPSSensors_setBarometricPressure(
