...
Java_org_tophat_NativeVoltageListener_onVoltageValues(JNIEnv *env, jobject obj,
...
JNIEXPORT void JNICALL
Java_org_tophat_NativeVoltageListener_onVoltageError(JNIEnv *env, jobject obj)
{
  jlong ptr = env->GetLongField(obj, NativeVoltageListener::ptr_field);
  if (ptr == 0)
    return;
...
{
  cls.Find(env, "org/tophat/NativeVoltageListener");
