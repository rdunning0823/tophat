...
extern const uint8_t en_start[] asm("_binary_en_mo_start");
extern const uint8_t en_size[] asm("_binary_en_mo_size");
...
const BuiltinLanguage language_table[] = {
  { LANG_CZECH, cs_start, cs_size, _T("cs.mo"), N_("Czech") },
  { LANG_DANISH, da_start, da_size, _T("da.mo"), N_("Danish") },
  { LANG_GERMAN, de_start, de_size, _T("de.mo"), N_("German") },
  { LANG_GREEK, el_start, el_size, _T("el.mo"), N_("Greek") },
  { LANG_ENGLISH, en_start, en_size, _T("en.mo"), N_("English") },
  { LANG_SPANISH, es_start, es_size, _T("es.mo"), N_("Spanish") },
  { LANG_FINNISH, fi_start, fi_size, _T("fi.mo"), N_("Finnish") },
  { LANG_FRENCH, fr_start, fr_size, _T("fr.mo"), N_("French") },
  { LANG_HEBREW, he_start, he_size, _T("he.mo"), N_("Hebrew") },
  { LANG_CROATIAN, hr_start, hr_size, _T("hr.mo"), N_("Croatian") },
  { LANG_HUNGARIAN, hu_start, hu_size, _T("hu.mo"), N_("Hungarian") },
  { LANG_ITALIAN, it_start, it_size, _T("it.mo"), N_("Italian") },
  { LANG_JAPANESE, ja_start, ja_size, _T("ja.mo"), N_("Japanese") },
  { LANG_KOREAN, ko_start, ko_size, _T("ko.mo"), N_("Korean") },
  { LANG_LITHUANIAN, lt_start, lt_size, _T("lt.mo"), N_("Lithuanian") },
  { LANG_NORWEGIAN, nb_start, nb_size, _T("nb.mo"), N_("Norwegian") },
  { LANG_DUTCH, nl_start, nl_size, _T("nl.mo"), N_("Dutch") },
  { LANG_POLISH, pl_start, pl_size, _T("pl.mo"), N_("Polish") },
  { LANG_PORTUGUESE, pt_BR_start, pt_BR_size, _T("pt_BR.mo"), N_("Brazilian Portuguese") },
