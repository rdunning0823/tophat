...
BetaFeatureConfigPanel::Prepare(ContainerWindow &parent, const PixelRect &rc)
{
  ...
  AddFloat(_("Circling min turn rate"),
           _("Select the minimum rate of turn (degrees / second) when the system detects turning."),
           _T("%.0f %s"), _T("%.0f"),
  ...
  AddFloat(_("Cruise to climb switch"),
           _("Select the number seconds of detected turning before Climb mode is entered."),
           _T("%.0f %s"), _T("%.0f"),
  ...
  AddFloat(_("Climb to cruise switch"),
           _("Select the number seconds of not detecting turning before Cruise mode is entered."),
           _T("%.0f %s"), _T("%.0f"),
           fixed(1), fixed(25), fixed(1), true,
