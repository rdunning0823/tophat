...
static PanelControl *filter_panel;
                       ...
                       bool goto_button)
{
  ...
  filter_panel = (PanelControl*)dialog->FindByName(_T("frmSearch"));
  assert(filter_panel != nullptr);
  filter_panel->SetVisible(false);

  name_sort_button = (WndButton*)dialog->FindByName(_T("frmcmdByName"));
  distance_sort_button = (WndButton*)dialog->FindByName(_T("frmcmdByDistance"));
  bearing_sort_button = (WndButton*)dialog->FindByName(_T("frmcmdByDistance"));
