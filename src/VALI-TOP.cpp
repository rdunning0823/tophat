...
/* This creates the VALI-TOP.exe program
...
static const char szInfo[] = "Vali TOP for the Top Hat Flight Computer Version 1.0.0";
...
{
  printf("vali-top for the Top Hat Flight Computer Version 1.0.0\n");
