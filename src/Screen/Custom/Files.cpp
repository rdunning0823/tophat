...
static const char *const all_font_paths[] = {
  ...
  "/opt/tophat/share/fonts/Vera.ttf",
#else
...
#elif defined(KOBO)
  "/mnt/onboard/TopHat/fonts/DejaVuSansCondensed-Bold.ttf",
  "/mnt/onboard/fonts/VeraBd.ttf",
  "/opt/tophat/share/fonts/VeraBd.ttf",
...
static const char *const all_italic_font_paths[] = {
  ...
  "/opt/tophat/share/fonts/VeraIt.ttf",
#elif defined(HAVE_POSIX)
...
static const char *const all_bold_italic_font_paths[] = {
  ...
  "/opt/tophat/share/fonts/VeraBI.ttf",
#elif defined(HAVE_POSIX)
...
static const char *const all_monospace_font_paths[] = {
  ...
  "/opt/tophat/share/fonts/VeraMono.ttf",
#else
